...
let printtableStr = stringArr.reduce((wholeString: string, item: string) => wholeString + ", " + item);
console.log("[ " + printtableStr + " ]");
...
let bePositive: {postive: boolean, content: string}[] = verbs.filter(s => s.positive);
